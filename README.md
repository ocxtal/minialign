...
* 2016/11/25 (0.4.0) Added mapping quality output, fix bug in chaining, and change output threshold measure from length to score (note: '-r' option is interpreted as score ratio).
